...
const window = { location: { pathname: '/index.html' }, addEventListener: () => {} };
...
const BOOK_DATASETS = {
  ...
  ibnmajah: [
    ...
    { id: 'native_ahmedbaset',
      ...
      note: 'ID translation sourced from Lidwa/Irsyad, matched by using Arabic Hadith text matching algorithm', noteId: 'Terjemahan ID bersumber dari Lidwa/Irsyad, berdasarkan algoritma kecocokan text Arab dalam hadits' },
    { id: 'native_lidwa',
      label: 'Lidwa Edition', labelId: 'Edisi Lidwa',
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (document.getElementById('tisah-grid') || document.getElementById('books-grid')) {
    loadBooksGrid();
  }
...
async function loadBooksGrid() {
  const container = document.getElementById('tisah-grid') || document.getElementById('books-grid');
  if (!container) return;
