...
dll_path = r"G:\AntigravityPortable\.gemini\antigravity\scratch\hadeeth_id\scratch\dbb32\DB.Browser.for.SQLite-3.12.2-win32\sqlcipher.dll"
try:
    sqlcipher = ctypes.CDLL(dll_path, winmode=0)
except Exception as e:
    print(f"Error loading DLL: {e}")
    # Try 32-bit python? Let's check python bitness
    import sys
