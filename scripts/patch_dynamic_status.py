...
old_status = 'if (statusEl) statusEl.innerHTML = `<span data-lang-en>N/A (Not in dataset)</span><span data-lang-id style="display:none">N/A (Tidak tercatat)</span>`;'

new_status = '''if (statusEl) {
    if (data && data.status) {
...
with open('js/app.js', 'w', encoding='utf-8') as f:
    f.write(app_js)
print("Patched app.js to use dynamic status!")
